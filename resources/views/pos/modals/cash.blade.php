        ...
        <div class="w-full max-w-md rounded-2xl bg-white p-6 shadow-xl dark:bg-neutral-900">
            ...
            <div class="mt-4 space-y-2">
                ...
                <div class="grid grid-cols-4 gap-2">
                    @foreach ([['v' => 0.5, 'l' => '0,50'], ['v' => 1, 'l' => '1'], ['v' => 2, 'l' => '2'], ['v' => 5, 'l' => '5'], ['v' => 10, 'l' => '10'], ['v' => 20, 'l' => '20'], ['v' => 50, 'l' => '50'], ['v' => 100, 'l' => '100']] as $d)
                        <button type="button" wire:click="addCash({{ $d['v'] }})" class="rounded-lg border border-neutral-300 py-3 text-sm font-medium dark:border-neutral-700">+{{ $d['l'] }} €</button>
                    @endforeach
                </div>
            </div>
            ...
            <div class="mt-6 flex gap-3">
                ...
                <button type="button" wire:click="confirmCash" @disabled($this->changeAmount < 0)
